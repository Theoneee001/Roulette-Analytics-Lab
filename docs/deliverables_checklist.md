...
| Random-walk and LLN simulation | [analysis](../src/roulette_lab/analysis.py), [bankroll](../src/roulette_lab/bankroll.py) | [analysis tests](../tests/test_analysis.py), [bankroll tests](../tests/test_bankroll.py) | [LLN figure](../outputs/figures/03_lln_convergence.png) | [probability contract](../report/technical_report.pdf) | [Live Experiment](../app.py) | Complete |
